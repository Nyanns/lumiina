...
<head>
	...
	<style>
		* { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
		...
		.feature-box { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 16px; margin-bottom: 28px; font-size: 13px; color: #334155; line-height: 1.5; }
		...
		.feature-box li::before { content: "✓"; color: #0096fa; font-weight: 700; }
	...
	<main class="main">
		<div class="container">
			<div class="status-badge">
				<div class="status-dot"></div> Email Verified
			</div>
			<h1>Your Account is Now Active</h1>
			<p>Welcome to the Lumiina illustration community! Your email address has been successfully verified, and your account is ready to use.</p>
			
			<div class="feature-box">
				<ul>
					<li>Publish your digital fan art and original illustrations</li>
					<li>Bookmark and comment on your favorite community artworks</li>
					<li>Follow talented anime illustrators and creators</li>
				</ul>
			</div>
